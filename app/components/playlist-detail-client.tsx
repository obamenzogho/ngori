              ...
              <div className="mt-6 sm:mt-8">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-600 transition hover:bg-slate-200 hover:text-[#1a1a2e]"
                  >
                    <IconCopy size={14} />
                    Copier
                  </button>
